...
import 'package:sapatos/src/pages/zapato_desc_page.dart';
...
class _TallaZapatoCaja extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final zapatoModel = Provider.of<SapatoModel>(context);

    return GestureDetector(
      onTap: () {
        final zapatoModel = Provider.of<SapatoModel>(context, listen: false);
...
class _ZapatoConSombra extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sapatoModel = Provider.of<SapatoModel>(context);
    ...
    return Stack(
      children: <Widget>[
        ...
        Image( image: AssetImage(sapatoModel.assetsImage ), )
