...
import 'package:sapatos/src/widgets/boton_naranja.dart';
    ...
    return FadeInLeft(
      ...
      child: GestureDetector(
        onTap: () {
          ...
          final sapatoModel = Provider.of<SapatoModel>(context, listen: false);
          sapatoModel.assetsImage = this.urlImagen;
